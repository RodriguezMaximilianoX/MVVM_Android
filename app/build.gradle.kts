...
dependencies {
    ...
    //Coroutines
    implementation("org.jetbrains.kotlinx:kotlinx-coroutines-android:$corroutinesVersion")
    testImplementation("org.jetbrains.kotlinx:kotlinx-coroutines-test:$corroutinesVersion")
    //Hilt
